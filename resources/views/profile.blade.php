              ...
              <li>
                <div class="about-slider">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 about-slider-description">
                    ...
                    <p class="welcome-message">Nama Lengkap : Alfina Nur A <br> Tempat tanggal lahir : Tuban, 17 Agustus 2001<br>
                    Jenis Kelamin : Perempuan<br> Hobby : Menonton youtube<br> Makanan favorit : Ayam Geprek<br>
                    Minuman Favorit : Air Putih</p>
                  </div>              
                </div>  
              </li>
              <li>
