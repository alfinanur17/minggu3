          ...
          <div class="templatemo-header">
            ...
            <div class="templatemo-nav-container">
              <nav class="templatemo-nav">
                <ul>
                 <li><a href="{{ asset('motor/index.html') }}" class="active">Home</a></li>
                 <li><a href="{{ asset('motor/products.html') }}">Products</a></li>
                 <li><a href="{{ asset('motor/services.html') }}">Services</a></li>
                 <li><a href="{{ asset('motor/gallery.html') }}">Gallery</a></li>
                 <li><a href="{{ asset('motor/contact.html') }}">Contact</a></li>
               </ul>
             </nav> 
           </div>
         </div>
